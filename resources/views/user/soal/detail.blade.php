                    ...
                    <div class="card-body">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p> : {{ $ujian->waktu_selesai }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p><strong>Sisa Waktu </strong></p>
                                </td>
                                <td>
                                    <p> : <span id="timer" class="fw-bold text-danger"></span></p>
                                </td>
                            </tr>
                        </table>
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('user.soal.index', ['topik_id' => $topik->id]) }}" class="btn btn-primary btn-sm">
